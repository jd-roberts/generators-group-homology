...
Gen:=Sublist;
for x in Sublist do
     TestWord:=Reduce_Word(Freegroup,Relators,x,
     Difference(Gen,[x]),Prime);
     Add(list,TestWord);
...
SecondHomologyCoefficients:=function(Freegroup, Relators, Prime,
    Sublist)
